...
var SearchBar = React.createClass({
  ...
  render: function() {
    return (
      <form>
        <input ref="filterTextInput" type="text" placeholder="Search..." value={this.props.filterText} onChange={this.handleChange} />
        <p>
...
var PRODUCTS = [
  ...
  {category: 'Electronics', price: '$399.99', stocked: false, name: 'iPhone 6 16gb'},
